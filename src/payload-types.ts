...
/**
 * Откройте страницу, чтобы изменить текст, изображения и порядок блоков.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "SiteHeroBlock".
 */
export interface SiteHeroBlock {
  ...
  description?: string | null;
  image?: (number | null) | Media;
  height?: ('compact' | 'large' | 'screen') | null;
  overlay?: number | null;
  buttons?:
    | {
        label: string;
...
/**
 * Фотографии, иллюстрации и схемы, используемые на страницах.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface Media {
  id: number;
  /**
   * Коротко опишите изображение для доступности и поисковых систем.
   */
  alt?: string | null;
  caption?: {
    root: {
...
export interface GalleryBlock {
  ...
  title: string;
  description?: string | null;
  layout?: ('mosaic' | 'grid' | 'carousel') | null;
  images?:
    | {
        image?: (number | null) | Media;
        caption?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "MapPlanBlock".
 */
...
export interface BookingBlock {
  ...
  description?: string | null;
  /**
   * Например: https://n123456.yclients.com/
   */
...
/**
 * Пользователи, которым разрешено редактировать сайт.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    | T
    | {
        siteHero?: T | SiteHeroBlockSelect<T>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "SiteHeroBlock_select".
 */
export interface SiteHeroBlockSelect<T extends boolean = true> {
  anchor?: T;
  theme?: T;
  eyebrow?: T;
  title?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "StaysBlock_select".
 */
export interface StaysBlockSelect<T extends boolean = true> {
  anchor?: T;
  theme?: T;
  eyebrow?: T;
  title?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "MapPlanBlock_select".
 */
export interface MapPlanBlockSelect<T extends boolean = true> {
  anchor?: T;
  theme?: T;
  eyebrow?: T;
  title?: T;
...
/**
 * Ссылки в верхней части каждой страницы сайта.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
/**
 * Ссылки в нижней части каждой страницы сайта.
 *
 * This interface was referenced by `Config`'s JSON-Schema
